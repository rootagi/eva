...
This directory contains the official documentation for Eva CLI, mirroring the content available at the [Eva website](https://eva-cli.vercel.app).

## Contents

| Document | Description |
| --- | --- |
| [Getting Started](index.md) | Installation, setup, and key features overview. |
...
This documentation corresponds to **Eva CLI v4.0.0**.
